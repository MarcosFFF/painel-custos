...
# ============================================================
    ...
    with tab_temp:
        ...
        if not nomes_temp:
            ...
            # ---- ordena a grade por CS crescente (do menos severo pro mais severo) ----
            rank_temp = rank_temp.sort_values("cs", ascending=True)
            ...
            exib_rank_temp["cs"] = exib_rank_temp["cs"].map(fmt_float2)
