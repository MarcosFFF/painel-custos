...
ARQUIVOS ESPERADOS (pasta configurada em PASTA_DIVIDIDOS, ex.: C:\\Users\\marcosfc\\Desktop\\divididos):
...
# ============================================================
# CAMINHO DOS ARQUIVOS DIVIDIDOS (CSVs 4016R e partes)
# Ajustado para a nova pasta local do usuário.
# ============================================================
PASTA_DIVIDIDOS = r"C:\Users\marcosfc\Desktop\divididos"
...
def carregar_base_severidade(pasta=PASTA_DIVIDIDOS):
    ...
    if not candidatos:
        return None, f"Nenhum arquivo .csv encontrado em '{pasta}' (padrão *4016R.csv ou *4016R_parte_N.csv)."
    grupos_arquivo = {}
    for c in candidatos:
